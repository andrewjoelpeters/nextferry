# Backtest Report: exp28-tighter-bounds

> Tighter quantile bounds q25/q75 instead of q10/q90

**Date:** 2026-03-29 00:18:44  
**Sailing events:** 19348  
**Walk-forward folds:** 5  
**Training time:** 2m 36s
...
| 70% Interval Coverage | 42.5% (target: 70%) |
| Interval Width (mean) | 2.41 min |
| Interval Width (median) | 1.5 min |
...
| Coverage | 70.0% | 42.5% | -27.50 (worse) |
| Interval Width | 4.81 min | 2.41 min | -2.40 (better) |
...
|-------|---------|---------|----------|----------|----------|
| ed-king | 2.09 | 2.09 | +1.09 | +1.09 | 0.00 (no change) |
| sea-bi | 2.9 | 2.9 | +1.65 | +1.65 | 0.00 (no change) |
...
|---|---|---|---|---|---|
| ed-king | 2.09 | -0.84 | +1.09 | 2.02 | 271623 |
| sea-bi | 2.9 | -1.03 | +1.65 | 2.82 | 260469 |

## By Day of Week

| Day | Pinball Loss | Bias | p90 | Interval Width | N |
|---|---|---|---|---|---|
| Fri | 2.27 | -0.66 | +1.36 | 2.16 | 76527 |
| Mon | 2.23 | -0.69 | +1.26 | 2.47 | 81477 |
| Sat | 2.36 | -0.72 | +1.51 | 2.5 | 74514 |
| Sun | 3.42 | -1.15 | +1.92 | 3.44 | 71412 |
| Thu | 2.29 | -1.03 | +1.14 | 2.05 | 75306 |
| Tue | 1.96 | -0.94 | +0.98 | 2.05 | 77385 |
| Wed | 2.94 | -1.36 | +1.36 | 2.28 | 75471 |
...
```json
{
  "aggregate": {
    ...
    "overall_mae": 1.97,
    "overall_coverage_70pct": 42.5,
    "overall_mean_interval_width": 2.41,
    "overall_median_interval_width": 1.5,
    ...
    "by_route": {
      "ed-king": {
        ...
        "n": 271623,
        "mae": 1.67,
        "mean_interval_width": 2.02,
        "median_interval_width": 1.35,
      ...
      "sea-bi": {
        ...
        "n": 260469,
        "mae": 2.27,
        "mean_interval_width": 2.82,
        "median_interval_width": 1.72,
    ...
    "by_day_of_week": {
      "Sun": {
        ...
        "n": 71412,
        "mae": 2.66,
        "mean_interval_width": 3.44,
        "median_interval_width": 1.99,
      ...
      "Tue": {
        ...
        "n": 77385,
        "mae": 1.62,
        "mean_interval_width": 2.05,
        "median_interval_width": 1.3,
      ...
      "Wed": {
        ...
        "n": 75471,
        "mae": 2.42,
        "mean_interval_width": 2.28,
        "median_interval_width": 1.53,
      ...
      "Fri": {
        ...
        "n": 76527,
        "mae": 1.73,
        "mean_interval_width": 2.16,
        "median_interval_width": 1.5,
